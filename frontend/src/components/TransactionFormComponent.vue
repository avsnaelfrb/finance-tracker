<script setup lang="ts">
    ...
    <template>
        <div class="w-full">
            <!-- Error Alert -->
            <div v-if="transactionStore.errMsg" class="mb-6 p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800 text-red-600 dark:text-red-400 text-sm flex items-center gap-2 animate-fade-in">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <div class="p-1.5 bg-gray-100 dark:bg-dark-700/50 rounded-xl grid grid-cols-2 gap-1">
                    <button 
                        type="button"
                        ...
                        :class="formData.type === 'EXPENSE' ? 'bg-white dark:bg-dark-800 text-red-600 shadow-sm ring-1 ring-black/5 dark:ring-white/5' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'"
                    >
                        Pengeluaran
                    </button>
                    <button 
                        ...
                        class="py-2.5 text-sm font-bold rounded-lg transition-all flex items-center justify-center gap-2"
                        :class="formData.type === 'INCOME' ? 'bg-white dark:bg-dark-800 text-green-600 shadow-sm ring-1 ring-black/5 dark:ring-white/5' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'"
                    >
                        Pemasukan
                    </button>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <!-- Divider -->
                    <div class="h-px w-full bg-gray-200 dark:bg-dark-600"></div>
                </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            <select 
                                ...
                                required
                                class="w-full appearance-none px-4 py-3 rounded-xl border border-gray-200 dark:border-dark-600 text-gray-900 dark:text-white bg-white dark:bg-dark-800 focus:outline-none focus:ring-2 transition-all text-sm cursor-pointer"
                ...
                <div class="space-y-4">
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                type="date"
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-dark-600 text-gray-900 dark:text-white bg-white dark:bg-dark-800 focus:outline-none focus:ring-2 text-sm font-sans"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea 
                            ...
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-dark-600 text-gray-900 dark:text-white bg-white dark:bg-dark-800 focus:outline-none focus:ring-2 text-sm font-sans resize-none"
                            :class="formData.type === 'EXPENSE' ? 'focus:ring-red-500/20 focus:border-red-500' : 'focus:ring-green-500/20 focus:border-green-500'"
                        ></textarea>
                    </div>
                </div>
                ...
                <div class="pt-4 flex gap-3">
                    <button 
                        type="button" 
                        @click="$emit('close')"
                        class="flex-1 px-4 py-3 rounded-xl border border-gray-200 dark:border-dark-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-dark-700 transition-all"
                    >
                        Batal
                    </button>
                    <button 
